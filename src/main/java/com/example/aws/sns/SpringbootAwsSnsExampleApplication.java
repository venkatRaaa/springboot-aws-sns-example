...
public class SpringbootAwsSnsExampleApplication {
	...
	public String publishMessageToTopic(){
		 PublishRequest publishRequest=new PublishRequest(TOPIC_ARN,buildEmailTempalte(),"Notification: Network connectivity issue");
		 amazonSNSClient.publish(publishRequest);
		 return "Notification send successfully !!";
	}

	private String buildEmailTempalte() {
		return "Dear Customer ,\n"
				+ "\n"
				+ "\n"
				+ "Connection down US region."
				+ "\n"
				+ "All the servers in US region Data center are not accessible. We are working on it ! \n"
